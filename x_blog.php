			...
			?>
            	<div class="box">
					<div class="box-content">
						...
						<div class="box-wrapper"><?php echo $value['title'];?><span class="name"><img src="images/calendar.png" alt="calendar"><?php echo $value['show_date'];?></span>	
							<div class="row"><?php echo $value['less_content'];?></div>
						</div>
							
					</div>
					
					<div class="box-overlay magictime" data-hover="rotateLeft" data-return="">
						<img src="<?php echo $value['blog_img'];?>" alt="" style="width: 470px; height: 215px;">
					</div>
					
					<a class="link" href="fullblog.php?blogid=<?php echo $value['id'];?>&to=<?php echo $last;?>"></a>									
